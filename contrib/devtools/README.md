...
Setup
---------
Configuring the github-merge tool for the XUEZ repository is done in the following way:

    git config githubmerge.repository XUEZ/XUEZ
...
A script to optimize png files in the XUEZ

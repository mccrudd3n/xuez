...
In order to support loading of multiple wallets in xuez-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xuez.cpp.
...
Changes to xuez.cpp
----------------------
xuez.cpp is the entry point into xuez-qt, and as such, will require some minor modifications to provide hooks for

                                                                         ...
                                                                         tab(tab)
{
    ...
    case SendingTab:
        ...
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your Xuez addresses for receiving payments. It is recommended to use a new receiving address for each transaction."));

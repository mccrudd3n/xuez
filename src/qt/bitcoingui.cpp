                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Xuez Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXUEZ"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Xuez Core"), this);
    aboutAction->setStatusTip(tr("Show information about Xuez Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Xuez"));
    ...
    openAction->setStatusTip(tr("Open a Xuez: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Xuez Core help message to get a list with possible Xuez command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Xuez Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Xuez network", "", count));
}
...
{
    QString strTitle = tr("Xuez Core"); // default title

...
public:
    ...
    void setZXUEZControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzXUEZ_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzXUEZ_clicked();
    void on_pushButtonZXUEZControl_clicked();

...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ObfuscationDenominate:
        return tr("Xend Denominate");
    case TransactionRecord::ObfuscationCollateralPayment:
        return tr("Xend Collateral Payment");
    case TransactionRecord::ObfuscationMakeCollaterals:
        return tr("Xend Make Collateral Inputs");
    case TransactionRecord::ObfuscationCreateDenominations:
        return tr("Xend Create Denominations");
    case TransactionRecord::Obfuscated:
        return tr("Obfuscated");
    case TransactionRecord::ZerocoinMint:
        return tr("Converted XUEZ to zXUEZ");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zXUEZ");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received XUEZ from zXUEZ");
    case TransactionRecord::ZerocoinSpend_Change_zXUEZ:
        return tr("Minted Change as zXUEZ from zXUEZ Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zXUEZ to XUEZ");

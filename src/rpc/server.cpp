...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Xuez features */
        {"xuez", "masternode", &masternode, true, true, false},
        {"xuez", "listmasternodes", &listmasternodes, true, true, false},
        {"xuez", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xuez", "masternodeconnect", &masternodeconnect, true, true, false},
        {"xuez", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xuez", "masternodedebug", &masternodedebug, true, true, false},
        {"xuez", "startmasternode", &startmasternode, true, true, false},
        {"xuez", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xuez", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xuez", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xuez", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xuez", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xuez", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xuez", "mnbudget", &mnbudget, true, true, false},
        {"xuez", "preparebudget", &preparebudget, true, true, false},
        {"xuez", "submitbudget", &submitbudget, true, true, false},
        {"xuez", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xuez", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xuez", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xuez", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xuez", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xuez", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"xuez", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xuez", "checkbudgets", &checkbudgets, true, true, false},
        {"xuez", "mnsync", &mnsync, true, true, false},
        {"xuez", "spork", &spork, true, true, false},
        {"xuez", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"xuez", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xuezd, or the -server option to xuez-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Xuez Alert\" admin@foo.com\n"),

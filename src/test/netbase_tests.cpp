...
// Copyright (c) 2015-2018 The Xuez developers
...
{
    BOOST_CHECK(TestSplitHost("www.xuezcoin.com", "www.xuezcoin.com", -1));
    BOOST_CHECK(TestSplitHost("[www.xuezcoin.com]", "www.xuezcoin.com", -1));
    BOOST_CHECK(TestSplitHost("www.xuezcoin.com:80", "www.xuezcoin.com", 80));
    BOOST_CHECK(TestSplitHost("[www.xuezcoin.com]:80", "www.xuezcoin.com", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:41798", "127.0.0.1", 41798));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:41798", "127.0.0.1", 41798));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:41798", "::ffff:127.0.0.1", 41798));
    BOOST_CHECK(TestSplitHost("[::]:41798", "::", 41798));
    BOOST_CHECK(TestSplitHost("::41798", "::41798", -1));
    BOOST_CHECK(TestSplitHost(":41798", "", 41798));
    BOOST_CHECK(TestSplitHost("[]:41798", "", 41798));
...
{
    BOOST_CHECK(TestParse("127.0.0.1", "127.0.0.1:41798"));
    BOOST_CHECK(TestParse("127.0.0.1:41798", "127.0.0.1:41798"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:41798"));
    BOOST_CHECK(TestParse("::", "[::]:41798"));
    BOOST_CHECK(TestParse("[::]:41798", "[::]:41798"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:41798"));

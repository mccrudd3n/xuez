...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Xuez Core xuez-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xuez-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xuez transaction") + "\n" +
                               "  xuez-tx [options] -create [commands]   " + _("Create hex-encoded xuez transaction") + "\n" +
                               "\n";

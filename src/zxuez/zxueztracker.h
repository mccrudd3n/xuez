...
#ifndef XUEZ_ZXUEZTRACKER_H
#define XUEZ_ZXUEZTRACKER_H
...
public:
    CzXUEZTracker(std::string strWalletFile);
    ~CzXUEZTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzXUEZWallet* zXUEZWallet = NULL);

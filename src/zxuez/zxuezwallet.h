...
#ifndef XUEZ_ZXUEZWALLET_H
#define XUEZ_ZXUEZWALLET_H
...
public:
    CzXUEZWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZXUEZ(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZXUEZ(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
